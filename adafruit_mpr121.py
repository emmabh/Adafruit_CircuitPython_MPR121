...
class MPR121:
    ...
    def reset(self) -> None:
        ...
        self._write_register_byte(MPR121_CONFIG1, 0xBF)  # 18 samples, 63uA charge current
        self._write_register_byte(MPR121_CONFIG2, 0x38)  # 0.5uS charge time, 18 samples, 1ms period between sample
